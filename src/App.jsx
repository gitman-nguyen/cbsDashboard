    ...
    const initialReportData = {
      '06/2025': {
        ...
        growthMetrics: [ 
            ...
            { name: "Tổng số khách hàng", percentageValue: "+12.14%", absoluteValue: formatMillions(22964050), icon: Users, color: "text-green-400", description: "So với cùng kỳ 2024" }, 
            { name: "Tài khoản KKH", percentageValue: "-4.31%", absoluteValue: formatMillions(12922805), icon: ArrowDown, color: "text-red-400", description: "So với cùng kỳ 2024" }, 
            { name: "Tài khoản CKH", percentageValue: "+4.78%", absoluteValue: formatMillions(2974397), icon: ArrowUp, color: "text-green-400", description: "So với cùng kỳ 2024" }, 
            { name: "Tài khoản tiền vay", percentageValue: "+3.05%", absoluteValue: formatMillions(1236980), icon: ArrowUp, color: "text-green-400", description: "So với cùng kỳ 2024" }, 
        ],
        ...
        <div className="main-container min-h-screen text-white font-inter selection:bg-yellow-400 selection:text-gray-900 relative">
            ...
            <div className="relative z-10">
                ...
                <main id="dashboard-content" className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
                    ...
                    <section><AnimatedComponent className="flex items-center gap-4 mb-8"><CalendarCheck size={32} className="text-yellow-400" /><h3 className="text-3xl font-bold">Các công việc tiếp theo</h3></AnimatedComponent><AnimatedComponent><div className="bg-gradient-to-r from-yellow-500/80 to-yellow-600/80 p-1 rounded-2xl shadow-2xl"><div className="bg-[#1a2c28] p-8 rounded-xl"><p className="text-xl text-center font-semibold text-white tracking-wide">{nextSteps}</p></div></div></AnimatedComponent></section>
